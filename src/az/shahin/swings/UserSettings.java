...
public class UserSettings extends javax.swing.JDialog {
    ...
    public UserSettings(javax.swing.JFrame parent, boolean modal, AccountPojo pojo) {
        super(parent, modal);
        initComponents();
    ...
    public void LoadData() {
        txtUser.setText(pojo.getUsername());
        txtFirst.setText(pojo.getFirstname());
        txtLast.setText(pojo.getLastname());
        txtTel.setText(pojo.getTelephone());
        txtMail.setText(pojo.getEmail());
        if (pojo.getGender() == 'M') {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Return Easy Test Maker");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (txtFirst.getText().length() < 3 || txtFirst.getText().length() > 19) {
        ...
        } else if (!Validator.isValidEmailAddress(txtMail.getText()) && txtMail.getText().length() > 34 || !pojo.getEmail().equals(txtMail.getText())) {
            lblWarning.setText("Invalid Email adress  (or large) ");
        }else if (!pojo.getEmail().equals(txtMail.getText()) || accountSQL.RegistrationCheck(txtMail.getText(), false) == 1) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UserSettings dialog = new UserSettings(new javax.swing.JFrame(), true, null);
